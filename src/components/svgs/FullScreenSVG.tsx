...
const FullSceenSVG = ({ width = 16, height = 16 }: { width?: number, height?: number }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height={`${height}`} width={`${width}`} fill="currentColor" className="bi bi-arrows-fullscreen" viewBox="0 0 16 16">
